...
$name = $_POST['name'];
$mylink = 'http://www.aventoncreativo.com/games/crazycart1';
...
<img style="margin:10px auto; width:450px; height:140px" src="http://aventoncreativo.com/games/crazycart1/mail_logo.png"/>

<div style="background:#FFF; width:700px; height:400px; margin:10px auto;">

<div style="color:#000A68; font-size:18px; padding:30px 20px 20px 0px; text-align:left; margin:0 40px;">Hello <font color="#FFA400">'.$friendsname.'</font>,<br/><br/> Your friend '.$name.' has just played the Crazy Cart Challenge and wants to invite you to play the game.</div>
